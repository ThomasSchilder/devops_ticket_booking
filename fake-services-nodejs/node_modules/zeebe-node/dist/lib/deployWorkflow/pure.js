...
const NEA = __importStar(require("fp-ts/lib/NonEmptyArray"));
const isBuffer = (wf) => !!wf.definition;
exports.isBuffer = isBuffer;
const bufferOrFiles = (wf) => (0, exports.isBuffer)(wf) ? fp_ts_1.either.left([wf]) : fp_ts_1.either.right((0, exports.coerceFilenamesToArray)(wf));
